                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <input id="surname" type="text" class="form-control @error('surname') is-invalid @enderror" placeholder="Apellidos" name="surname" value="{{ old('surname') }}" required autocomplete="surname" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <input id="nick" type="text" class="form-control @error('nick') is-invalid @enderror" placeholder="Nombre de usuario" name="nick" value="{{ old('nick') }}" required autocomplete="nick" autofocus>
